...
export default function BoardRow({startIndex, squares, playerTurn, handleClick, classNames} : { startIndex: number, squares: Array<string>, playerTurn: boolean, handleClick : Function, classNames: string[]}) {
    return (
